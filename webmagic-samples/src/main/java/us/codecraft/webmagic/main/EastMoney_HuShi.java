...
public class EastMoney_HuShi implements PageProcessor {
...
//        System.out.println(JGCYDTypes);
    ...
    public static void main(String[] args) {
        ...
        //沪市A股 1622
        String url="http://dcfm.eastmoney.com/em_mutisvcexpandinterface/api/js/get?callback=datatable2037675&type=QGQP_LB&token=70f12f2f4f091e459a279469fe49eca5&cmd=&st=Code&sr=1&p=1&ps=1623&js=(%7Bpages%3A(tp)%2Cdata%3A(x)%2Cfont%3A(font)%7D)&filter=(Market%3D%272%27)&_=1617021552210";
        ...
        Spider.create(new EastMoney_HuShi())
