...
public class EastMoney_chuangYeBan implements PageProcessor {
...
//        System.out.println(JGCYDTypes);
    ...
    public static void main(String[] args) {
        ...
        //深市A股 474
        //String url="http://dcfm.eastmoney.com/em_mutisvcexpandinterface/api/js/get?callback=datatable2725998&type=QGQP_LB&token=70f12f2f4f091e459a279469fe49eca5&cmd=&st=Code&sr=1&p=1&ps=474&js=(%7Bpages%3A(tp)%2Cdata%3A(x)%2Cfont%3A(font)%7D)&filter=(Market%3D%276%27)&_=1617021444581";

        //创业板 934
        String url="http://dcfm.eastmoney.com/em_mutisvcexpandinterface/api/js/get?callback=datatable9155604&type=QGQP_LB&token=70f12f2f4f091e459a279469fe49eca5&cmd=&st=Code&sr=1&p=1&ps=934&js=(%7Bpages%3A(tp)%2Cdata%3A(x)%2Cfont%3A(font)%7D)&filter=(Market%3D%2780%27)&_=1617021163192";
        ...
        Spider.create(new EastMoney_chuangYeBan())
